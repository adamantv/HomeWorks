...
public class Main {
    public static void main(String[] args) {
        ...
        HashMap<Client, List<Account>> mapWithKeyClient = storageFactory.initializeMapWithKeyClient();
        List<Account> resultAccountList = mapWithKeyClient.get(client);
        System.out.println("Result accounts from Map: " + resultAccountList);

        HashMap<Account, Client> mapWithKeyAccount = storageFactory.initializeMapWithKeyAccount();
